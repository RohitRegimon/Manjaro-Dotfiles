!function(modules) {
    ...
    }, __webpack_require__.p = "", __webpack_require__(__webpack_require__.s = 917);
}({
    ...
    917: function(module, exports, __webpack_require__) {
        ...
        Config.initGlobal("chrome", "cs"), __webpack_require__(0).LogConfig.configure({
            edge: !1,
            prodCs: "prod" === Config.getGlobal().bundleInfo.env
        });
        var felogPixel = __webpack_require__(135), telemetry_1 = __webpack_require__(136), interface_1 = __webpack_require__(53), log = __webpack_require__(0).Logger.create("chrome.proxy"), browserObject = window.chrome || window.firefox, telemetry = new telemetry_1.Telemetry(felogPixel.sendEventPixel);
        function initProxy() {
