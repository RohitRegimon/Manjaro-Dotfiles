...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _blockCountManager = __webpack_require__(23);
	...
	(function ($) {
	      ...
	      switch (request.name) {
	        ...
	        case "toggleFunction":
	          if (request.toggle) {
	            ...
	            (0, _utils.executeCode)("window.pbExternalCommand && window.pbExternalCommand(1, \"" + pbMessage + "\");");
	          } else {
	            (0, _utils.executeCode)("window.pbExternalCommand && window.pbExternalCommand(0, \"" + pbMessage + "\");");
	          }
	          break;
	        case 'showRateUs':
	          showRateUsPopup();
	    ...
	    notification.show({
	      ...
	      buttons: {
	        ...
	        allowAlways: function allowAlways() {
	          ...
	          sendMessageToBackground({ name: 'KeenIO', data: { event: 'allow-always:pops', post: { 'domain': document.domain, 'url': location.href, 'pop': args[0] } } });
	  ...
	  function initBlockFunctions() {
	    _PBStorageSync2.default.many(_PBStorageSync2.default.pb_hideBadge, _PBStorageSync2.default.pb_whitelist, _PBStorageSync2.default.pb_overlaylist, _PBStorageSync2.default.pb_pause, _PBStorageSync2.default.pb_popupBlackList).get().then(function (settings) {
	  ...
	  _PBStorageSync2.default.pb_whitelist.get().then(function (whitelist) {
	    //get whitelist
	  ...
	  function onHyperLinkClicked(e) {
	    ...
	    if (isExtensionAlive() && href && href !== '#' && target !== '_self') {
	      ...
	      if (isOverlayish(el)) {
	        ...
	        _PBStorageSync2.default.pb_pause.get().then(function (isPause) {
	          if (!isPause) {
	            parent.postMessage({
	              type: "blockedWindow",
	    ...
	    value: function autoDetect() {
	      ...
	      if (attempt < 100) {
	        ...
	        if (foundBlockList.length) {
	          setTimeout(function () {
	            return _this6.onBlockListFound({ found: foundBlockList });
	          }, 750); //setTimout for UX purpuses
	        }

	        if (foundRecipeList.length) {
	          setTimeout(function () {
	            return _this6.onRecipeFound({ found: foundRecipeList });
	          }, 750); //setTimout for UX purpuses
	        }
	  ...
	  HTMLElement.prototype.appendChild = function () {
	    ...
	    if (newElement.nodeName == 'IFRAME' && newElement.contentWindow) {
	      try {
	        ...
	        var s = document.createElement('script');s.textContent = code;
